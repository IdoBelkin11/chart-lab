...
export const entries = [
  ...
  { id:'bond-yield-ytm', cat:'bonds', priority:2, kw:['yield to maturity','ytm','bond yield','תשואה לפדיון'],
  ...
  { id:'bond-price-interest-rate', cat:'bonds', priority:2, kw:['bond price and interest rates','why do bond prices fall when rates rise','מחיר אג"ח וריבית','למה מחיר אג"ח יורד כשריבית עולה'],
  ...
  { id:'credit-risk-and-ratings', cat:'bonds', priority:2, kw:['credit risk','credit rating','government bonds','corporate bonds','junk bonds','high yield bonds','סיכון אשראי','דירוג אשראי','אג"ח ממשלתיות','אג"ח קונצרניות','אג"ח זבל'],
