...
export const LESSONS: readonly CurriculumLesson[] = [
  ...
  { id: "R1", track: "R", module: 0, level: 1, kind: "lesson", title: { he: "מה זה בעצם סיכון", en: "What risk actually is" }, minutes: 10, kbTopics: ["risk","volatility","beta","drawdown"],
    steps: { he: ["מה זה סיכון","תנודתיות","ירידה מהשיא","כמה צריך כדי לחזור?","המתמטיקה של הפסד","3 דברים לזכור","הבא: פיזור ומתאם"], en: ["What risk is","Volatility","Drawdown","How much to get back?","The maths of a loss","3 things to keep","Next: diversification"] } },
  ...
  { id: "R3", track: "R", module: 0, level: 1, kind: "lesson", title: { he: "זמן, ריבית דריבית והפקדה קבועה", en: "Time, compounding and regular investing" }, minutes: 10, kbTopics: ["compound-interest","time-horizon","dollar-cost-averaging","lump-sum","market-timing"],
    steps: { he: ["רווח שמרוויח","להתחיל מוקדם","הפקדה קבועה","כמה זה יהיה?","מה הזמן עשה","3 דברים לזכור","הבא: גודל פוזיציה"], en: ["Profit that earns","Starting early","Regular investing","How much will it be?","What time did","3 things to keep","Next: position size"] } },
  ...
  { id: "M4", track: "M", module: 1, level: 2, kind: "lesson", title: { he: "אג״ח: קופון, תשואה ומחיר", en: "Bonds: coupon, yield and price" }, minutes: 14, kbTopics: ["bond","coupon","bond-yield-ytm","bond-price-interest-rate","duration","credit-risk-and-ratings","corporate-vs-government-bonds"],
    steps: { he: ["מה זה אג״ח","קופון ותשואה","מחיר מול ריבית","כמה שווה האג״ח?","משך ודירוג","3 דברים לזכור","הבא: עקום התשואות"], en: ["What a bond is","Coupon and yield","Price against rates","What is the bond worth?","Duration and rating","3 things to keep","Next: the yield curve"] } },
  ...
  { id: "M6", track: "M", module: 1, level: 2, kind: "lesson", title: { he: "דולר, זהב וסחורות", en: "The dollar, gold and commodities" }, minutes: 14, kbTopics: ["dollar-strength","gold","commodities"],
    steps: { he: ["הדולר","זהב","סחורות","מה הייתם מצפים?","קשרים שנשברים","3 דברים לזכור","הבא: מי מזיז את השוק"], en: ["The dollar","Gold","Commodities","What would you expect?","Links that break","3 things to keep","Next: who moves the market"] } },
  { id: "M7", track: "M", module: 2, level: 3, kind: "lesson", title: { he: "מוסדיים, עושי שוק ו\"מגולם במחיר\"", en: "Institutions, market makers and \"priced in\"" }, minutes: 16, kbTopics: ["institutional-investors","market-makers","efficient-markets-priced-in","insider-trading","arbitrage"],
    steps: { he: ["מי בשוק","עושי שוק","מגולם במחיר","צפוי או הפתעה?","מידע פנים וארביטראז׳","3 דברים לזכור","הבא: נגזרים"], en: ["Who is in the market","Market makers","\"Priced in\"","Expected or surprise?","Inside information and arbitrage","3 things to keep","Next: derivatives"] } },
