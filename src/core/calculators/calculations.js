// Pure financial maths. No DOM, no UI — ports unchanged to any renderer.
// ---------------------------------------------------------------------------
...
export function compoundInterest(principal, ratePct, years, contributionPerYear){
...
export function dollarCostAverage(amountPerPeriod, numberOfPeriods, annualReturnPct, periodsPerYear){
...
export function percentageReturn(initialValue, finalValue){
...
export function profitLoss(buyPrice, sellPrice, shares, buyFees, sellFees){
  buyFees = buyFees || 0;
  sellFees = sellFees || 0;
...
export function dividendYield(price, annualDividendPerShare){
